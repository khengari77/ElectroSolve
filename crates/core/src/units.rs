...
pub fn combine_series(z1: ImpedanceResult, z2: ImpedanceResult) -> ImpedanceResult {
    match (&z1, &z2) {
        (ImpedanceResult::Open, _) | (_, ImpedanceResult::Open) => ImpedanceResult::Open,
        ...
        (ImpedanceResult::Short, ImpedanceResult::Short) => ImpedanceResult::Short,
...
pub fn combine_parallel(z1: ImpedanceResult, z2: ImpedanceResult) -> ImpedanceResult {
    match (&z1, &z2) {
        (ImpedanceResult::Short, _) | (_, ImpedanceResult::Short) => ImpedanceResult::Short,
        ...
        (ImpedanceResult::Open, ImpedanceResult::Open) => ImpedanceResult::Open,
...
pub fn combine_series_many(impedances: &[ImpedanceResult]) -> ImpedanceResult {
    ...
    let z_sum: Complex64 = finite_vals.iter().sum();
